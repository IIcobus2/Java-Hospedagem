...
public class ChaleController {
	...
	public String inserir(Chale emp){
		String sql = "INSERT INTO bancoreserva.tb_chales(\"localizacao\", \"capacidade\", \"valorAltaEstacao\", \"valorBaixaEstacao\") VALUES (?, ?, ?, ?)";
		Connection con = ConnectionFactory.getConnection();
		try{
			PreparedStatement pst = con.prepareStatement(sql);
			pst.setString(1, emp.getLocalizacao());
			pst.setInt(2, emp.getCapacidade());
			pst.setInt(3, emp.getValorAltaEst());
			pst.setInt(4, emp.getValorBaixaEst());
